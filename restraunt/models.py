...
class Restraunt(BaseModel):
    ...
    restraunt_image = models.ImageField(upload_to = 'restraunts_name', null= True, blank=True)
...
class RestrauntMenu(BaseModel):
    ...
    menu_image = models.ImageField(upload_to='restraunt_menu', null=True , blank=True)
